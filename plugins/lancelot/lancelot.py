...
class Plugin(ShortcodePlugin):
    ...
    def handler(self, title=None, site=None, data=None, lang=None,
        ...
        pass the string as the first argument to this method. So for my future
        self, put the title first or never forget the keyword.
        ...
        """
        success, twin_slugs, title, permalink, slug = lancelot_link(site=site,
                                                                    slug=data,
                                                                    title=title)
        if success:
            if twin_slugs:
