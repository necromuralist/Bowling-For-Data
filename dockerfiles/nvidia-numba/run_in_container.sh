...
chown -R bravo:bravo /home/bravo/.ssh/authorized_keys
chown -R bravo:bravo /home/bravo/setup_conda.sh

# update the conda installation (this has to be run by root)
/opt/conda/condabin/conda update -n base -c defaults conda
